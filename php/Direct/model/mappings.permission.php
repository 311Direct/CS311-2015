...
{
   /* From the PermAssignmentMappings Table */
    ...
    if($projectContext > -1)
    {
      ...
      try
      {
        if($stmt->execute()){
          ...
          if(count($possibleMatches) == 1)
          {            
            $this->_permAssignmentModel = new PermAssignmentMappingsModel($projectContext, $possibleMatches[0]['projectid'], $possibleMatches[0]['role'], $possibleMatches[0]['id']); 
            return $this;
          }        
  ...
  public function getAssignmentModel()
  {
